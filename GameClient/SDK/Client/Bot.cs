...
public unsafe class Bot(string host, int port)
{
    ...
    public GameInfoBuilder? GameInfo { get; private set; }
    ...
    public bool Drop()
    {
        ...
        try
        {
            ...
            fixed (byte* ptr = data.AsSpan())
            {
                *(CommandProto*)ptr = CommandProto.DropProto;
                *(DropProto*)(ptr + sizeof(CommandProto)) = proto;
            }
    ...
    public bool FetchGameInfo()
    {
        try
        {
            ...
            this.GameInfo = GameInfoBuilder.FromProto(this.rBuffer[..len]);
            return true;
        }
        catch
        {
